...
- Transparent JWT login generated by OSCAR Dashboard.
...
The dashboard-generated JWT uses `FILEBROWSER_JWT_SUB` as the username, defaulting to `user`, and grants full FileBrowser permissions through `userDefaults` and the `admin` group.
